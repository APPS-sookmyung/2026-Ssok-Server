package com.ssok.server.domain.auth.controller;
...
public class AuthController {
    ...
    public ResponseEntity<ApiResponse<RegisterResponse>> register(@RequestBody @Valid RegisterRequest request) {
        ...
        return ResponseEntity.status(HttpStatus.CREATED)
                .body(ApiResponse.success(HttpStatus.CREATED.value(), "register success", response));
    }
    ...
    public ResponseEntity<ApiResponse<LoginResponse>> login(@RequestBody @Valid LoginRequest request) {
        ...
        return ResponseEntity.ok(ApiResponse.success(HttpStatus.OK.value(), "login success", response));
    }
}
